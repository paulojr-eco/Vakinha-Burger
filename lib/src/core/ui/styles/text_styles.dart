...
class TextStyles {
  ...
  TextStyle get textRegular => TextStyle(fontWeight: FontWeight.w500, fontFamily: fontFamily);
  TextStyle get textMedium => TextStyle(fontWeight: FontWeight.normal, fontFamily: fontFamily);
